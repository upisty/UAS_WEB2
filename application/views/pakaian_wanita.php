<div class="container-fluid">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="true">
        ...
        <div class="carousel-inner">
            ...
            <img src="<?php echo base_url('assets/img/slider-woman.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="<?php echo base_url('assets/img/slider-woman-3.jpg') ?>" class="d-block w-100" alt="...">
            </div>
        </div>
